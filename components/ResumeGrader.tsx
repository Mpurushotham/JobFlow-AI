...
export const ResumeGrader: React.FC<ResumeGraderProps> = ({ profile, subscriptionTier }) => {
                ...
                <div className="text-center flex flex-col items-center justify-center h-full">
                    ...
                    <button 
                      ...
                      className={`mt-8 px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg transition-colors
                        ${isFreeTierLimitReached ? 'bg-gray-200 dark:bg-slate-700 text-gray-500 dark:text-slate-400 cursor-not-allowed' :
                    ...
                    {isFreeTierLimitReached && (
                      <p className="text-sm text-red-500 dark:text-red-400 mt-3 flex items-center justify-center gap-1">
                        <Info size={16}/> Free tier limit reached. Upgrade to AI Pro for unlimited checks.
                      </p>
                    )}
                </div>
            ) : (
